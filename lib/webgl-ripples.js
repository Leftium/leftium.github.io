...
class Ripples {
  constructor(el, options) {
    ...
    this.options = { ...DEFAULTS, ...options }; // Use Ripples.DEFAULTS now
  ...
  setupPointerEvents() {
    ...
    this.el.addEventListener("touchmove", dropAtPointerTouch, { signal });
    this.el.addEventListener("touchstart", dropAtPointerTouch, { signal });
